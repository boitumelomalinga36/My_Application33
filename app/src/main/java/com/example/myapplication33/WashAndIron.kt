...
class WashAndIron : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databaseReference = FirebaseDatabase.getInstance().reference.child("washIron")
        ...
        recyclerView = findViewById(R.id.recyclerViewWashAndIron)
        ...
        val addToCartButton = findViewById<Button>(R.id.button7WashAndIron)
