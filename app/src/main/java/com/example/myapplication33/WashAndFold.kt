...
class WashAndFold : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databaseReference = FirebaseDatabase.getInstance().reference.child("washFold")
        ...
        recyclerView = findViewById(R.id.recyclerViewFold)
        ...
        val addToCartButton = findViewById<Button>(R.id.button7Fold)
