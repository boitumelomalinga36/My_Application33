...
class Iron : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databaseReference = FirebaseDatabase.getInstance().reference.child("ironOnly")
        ...
        recyclerView = findViewById(R.id.recyclerViewIron)
        ...
        val addToCartButton = findViewById<Button>(R.id.button7iron)
